    ...
    public int Event8000(int ButtonType, int StageAverageReward,PlayerManager PlayerMgr, PlaySceneUIManager UIMgr, ref string Getting, ref string Losing)
    {
        ...
        switch (ButtonType)
        {
            ...
            case 3:
                ...
                {
                    Getting = "+装備 : " + EquipmentInfoManager.Instance.GetPlayerEquipmentInfo(SmallCursedSword).EquipmentName;
                    Losing = "-装備 : " + EquipmentInfoManager.Instance.GetPlayerEquipmentInfo(CursedSword).EquipmentName;
                }
                else
                {
                    Getting = "+장비 : " + EquipmentInfoManager.Instance.GetPlayerEquipmentInfo(SmallCursedSword).EquipmentName;
                    Losing = "-장비 : " + EquipmentInfoManager.Instance.GetPlayerEquipmentInfo(CursedSword).EquipmentName;
                }
    ...
    public int Event8030(int ButtonType, PlayerManager PlayerMgr, PlaySceneUIManager UIMgr, ref string Getting, ref string Losing)
    {
        ...
        switch (ButtonType)
        {
            case 0:
                ...
                {
                    Getting = "+装備 : " + EquipmentInfoManager.Instance.GetPlayerEquipmentInfo(HolySword).EquipmentName;
                }
                else
                {
                    Getting = "+장비 : " + EquipmentInfoManager.Instance.GetPlayerEquipmentInfo(HolySword).EquipmentName;
                }
        ...
        switch (ButtonType)
        {
            case 0:
                    ...
                    PlayerMgr.GetPlayerInfo().GetPlayerStateInfo().EquipWeaponCode == SmallCursedSword)
                {
                    ...
                    {
                        Losing = "-装備 : " + EquipmentInfoManager.Instance.GetPlayerEquipmentInfo(WeaponCode).EquipmentName;
                    }
                    else
                    {
                        Losing = "-장비 : " + EquipmentInfoManager.Instance.GetPlayerEquipmentInfo(WeaponCode).EquipmentName;
                    }
    ...
    public int Event8050(int ButtonType, PlayerManager PlayerMgr, PlaySceneUIManager UIMgr, ref string Getting, ref string Losing)
    {
        ...
        switch (ButtonType)
        {
            case 0:
                ...
                {
                    Getting = "+装備 : " + EquipmentInfoManager.Instance.GetPlayerEquipmentInfo(BlessedSword).EquipmentName;
                }
                else
                {
                    Getting = "+장비 : " + EquipmentInfoManager.Instance.GetPlayerEquipmentInfo(BlessedSword).EquipmentName;
                }
